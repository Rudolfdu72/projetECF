<?php
  ...
  if(isset($_POST['suscribe'])){
      ...
      if(!empty($_POST['firstname']) AND !empty($_POST['password']) AND !empty($_POST['password_confirm']) AND
...
<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="employes">
  <div>
    <label>Nom:</label>
